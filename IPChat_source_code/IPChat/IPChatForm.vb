...
Public Class frmIPChat
    ...
    'Dim machineip As String = serveriplist.AddressList(0).ToString()   ' for XP
    'Dim machineip As String = serveriplist.AddressList(2).ToString()    ' for Vista
    'Dim machineip As String = serveriplist.AddressList(1).ToString()    ' for Win7
